Vikingcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/vikingcoin/files/Vikingcoin/vikingcoin-0.5.4/
...
http://gitorious.org/vikingcoin/vikingcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Vikingcoin-Qt notifications under Growl 1.3.
Increase required age of Vikingcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxVikingcoin properly when installing Vikingcoin-Qt over it. (Windows)
