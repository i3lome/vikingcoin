Vikingcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/vikingcoin/files/Vikingcoin/vikingcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Vikingcoin
...
New/changed settings (command-line or vikingcoin.conf file)
--------------------------------------------------------
