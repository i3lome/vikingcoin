The following is a list of assets used in the vikingcoin source and their proper attribution.
...
* License: MIT
* Site: [https://vikingcointalk.org/index.php?topic=15276.0](https://vikingcointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original vikingcoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/vikingcoin.icns, src/qt/res/src/vikingcoin.svg,
	src/qt/res/src/vikingcoin.ico, src/qt/res/src/vikingcoin.png,
	src/qt/res/src/vikingcoin_testnet.png, docs/vikingcoin_logo_doxygen.png,
