Vikingcoin Core version 0.9.2 is now available from:
...
installer (on Windows) or just copy over /Applications/Vikingcoin-Qt (on Mac) or
vikingcoind/vikingcoin-qt (on Linux).
...
- Lower paytxfee warning threshold from 0.25 VIK to 0.01 VIK
...
- Fix "Start vikingcoin on system login"
