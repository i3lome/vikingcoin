...
ACLOCAL = ${SHELL} /root/vikingcoin/src/build-aux/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /root/vikingcoin/src/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /root/vikingcoin/src/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /root/vikingcoin/src/build-aux/missing --run automake-1.11
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /root/vikingcoin/src/build-aux/missing --run makeinfo
MAKENSIS = 
MKDIR_P = /bin/mkdir -p
MOC = /usr/bin/moc-qt4
...
PACKAGE_STRING = Vikingcoin Core 0.9.2
...
WINDRES = 
XGETTEXT = 
abs_builddir = /root/vikingcoin
abs_srcdir = /root/vikingcoin
abs_top_builddir = /root/vikingcoin
abs_top_srcdir = /root/vikingcoin
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_OBJC = gcc
ac_ct_OBJCXX = g++
...
install_sh = ${SHELL} /root/vikingcoin/src/build-aux/install-sh
