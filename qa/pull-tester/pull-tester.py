...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old VikingcoinPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/VikingcoindComparisonTool_jar/VikingcoindComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/vikingcoin/vikingcoin.git")
...
environ_default("BUILD_PATH", "/mnt/vikingcoin")
...
environ_default("GITHUB_REPO", "vikingcoin/vikingcoin")
