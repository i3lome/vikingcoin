...
VIKINGCOIND=${1}/vikingcoind
CLI=${1}/vikingcoin-cli
...
B4ARGS="-datadir=$D4"
$VIKINGCOIND $VIKINGCOINDARGS $B4ARGS &
B4PID=$!
...
B3ARGS="-datadir=$D3"
$VIKINGCOIND $VIKINGCOINDARGS $B3ARGS &
B3PID=$!
...
function StartThree {
  $VIKINGCOIND $VIKINGCOINDARGS $B1ARGS &
  B1PID=$!
  $VIKINGCOIND $VIKINGCOINDARGS $B2ARGS &
  B2PID=$!
  $VIKINGCOIND $VIKINGCOINDARGS $B3ARGS &
  B3PID=$!
}
