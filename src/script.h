...
#ifndef H_VIKINGCOIN_SCRIPT
#define H_VIKINGCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CVikingcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Vikingcoin always counted CHECKMULTISIGs
