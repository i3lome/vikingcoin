...
public:
    ...
    QLabel *amountLabel;
    VikingcoinAmountField *payAmount;
    QLabel *messageLabel;
    ...
    VikingcoinAmountField *payAmount_is;
    ...
    VikingcoinAmountField *payAmount_s;
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        payAmount = new VikingcoinAmountField(SendCoins);
        ...
        payAmount_is = new VikingcoinAmountField(SendCoins_InsecurePaymentRequest);
        ...
        payAmount_s = new VikingcoinAmountField(SendCoins_SecurePaymentRequest);
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the vikingcoin: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the Vikingcoin network.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
