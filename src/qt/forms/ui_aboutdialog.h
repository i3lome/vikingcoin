...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        copyrightLabel->setText(QString::fromUtf8("Copyright &copy; 2009-YYYY The Vikingcoin Core developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Vikingcoin Core", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("AboutDialog", "<b>Vikingcoin Core</b> version", 0, QApplication::UnicodeUTF8));
