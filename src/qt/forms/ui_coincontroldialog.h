...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QString::fromUtf8("0.00 VIK"));
        ...
        labelCoinControlFee->setText(QString::fromUtf8("0.00 VIK"));
        ...
        labelCoinControlAfterFee->setText(QString::fromUtf8("0.00 VIK"));
        ...
        labelCoinControlChange->setText(QString::fromUtf8("0.00 VIK"));
    ...
    {
        CoinControlDialog->setWindowTitle(QApplication::translate("CoinControlDialog", "Coin Control Address Selection", 0, QApplication::UnicodeUTF8));
