...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/vikingcoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Vikingcoin"),
     ...
     * override -datadir in the vikingcoin.conf file in the default data directory
     * (to be consistent with vikingcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
