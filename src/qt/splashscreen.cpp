    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString copyrightText   = QChar(0xA9)+QString(" 2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("Vikings"));
    QString copyrightText2  = QChar(0xA9)+QString(" 2013 ") + QString(tr("The Viking Team"));
