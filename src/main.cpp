...
#if defined(NDEBUG)
# error "Vikingcoin cannot be compiled without assertions."
#endif
...
int64_t CTransaction::nMinTxFee = 0.000001;
/** Fees smaller than this (in satoshi) are considered zero fee (for relaying and mining) */
int64_t CTransaction::nMinRelayTxFee = 0.000001;
...
const string strMessageMagic = "Vikingcoin Signed Message:\n";
...
static const int64_t nStartSubsidy = 0.01 * COIN;
static const int64_t nMinSubsidy = 0.00001066 * COIN;
...
static const int64_t nTargetTimespan = 1.5 * 60;
static const int64_t nTargetSpacing = 10 * 60;
static const int64_t nInterval = nTargetSpacing / nTargetTimespan;
...
{
        static const int64_t BlocksTargetSpacing = 2 *60; // 120 sec
...
void ThreadScriptCheck() {
    RenameThread("vikingcoin-scriptch");
...
bool ConnectBlock(CBlock& block, CValidationState& state, CBlockIndex* pindex, CCoinsViewCache& view, bool fJustCheck)
{
   ...
   //
    // This rule applies to all Vikingcoin blocks whose timestamp is after March 15, 2012, 0:00 UTC.
    //
    ...
    // as Vikingcoin, namely the one suggested below
    // This rule was originally applied all blocks whose timestamp was after March 15, 2012, 0:00 UTC.
    // Now that the whole chain is irreversibly beyond that time it is applied to all blocks except the
    // two in the chain that violate it. This prevents exploiting the issue against nodes in their
    // initial block download.
