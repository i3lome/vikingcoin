/* src/vikingcoin-config.h.  Generated from vikingcoin-config.h.in by configure.  */
/* src/vikingcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef VIKINGCOIN_CONFIG_H

#define VIKINGCOIN_CONFIG_H
